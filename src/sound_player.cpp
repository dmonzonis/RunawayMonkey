...
const float ListenerZ =
    300.f;  ///< Height of the sf::Listener over the game's plane.
const float Attenuation =
    8.f;  ///< Attenuation factor for sounds at a certain distance.
...
void SoundPlayer::play(Sounds::ID id) { play(id, getListenerPosition()); }
