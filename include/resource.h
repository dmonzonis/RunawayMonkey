 ...
 * prepared for use for all used resources are defined in @ref resource_identifiers.h
 *
...
public:
    ...
    /**
     * Returns a reference to the resource assigned to an identifier. Will return
     * an assertion error if the identifier is not associated with any
     * previously loaded resource.
     *
     * @param id Identifier associated with the resource to retrieve.
     *
     * @return Reference to the resource assigned to the identifier passed in the
     * argument.
     */
    ...
    /**
      * Returns a constant reference to the resource assigned to an identifier. Will return
      * an assertion error if the identifier is not associated with any
      * previously loaded resource.
      *
      * @param id Identifier associated with the resource to retrieve.
      *
      * @return Constant reference to the resource assigned to the identifier passed in the
      * argument.
      */
